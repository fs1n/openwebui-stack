...
graph TB
    ...
    %% Traffic flow
    Internet -->|HTTPS| OpenWebUI
    Internet -->|HTTPS| LiteLLM
    Internet -->|HTTPS| LGTM
...
```
127.0.0.1 localhost grafana.localhost litellm.localhost
```
...
1. **Use proper certificates**
   - Configure your external Caddy instance with Let's Encrypt or a CA-signed certificate
...
2. **Update security settings**
   ...
   - Configure rate limiting and security rules in your external reverse proxy
...
5. **opentelemetry-dashboard.json** - System-wide observability
   - Distributed traces
   - Span analysis
